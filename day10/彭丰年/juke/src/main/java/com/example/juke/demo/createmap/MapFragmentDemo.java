package com.example.juke.demo.createmap;
...
public class MapFragmentDemo extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        map1 = SupportMapFragment.newInstance(baiduMapOptions);
        FragmentManager manager = getSupportFragmentManager();
        manager.beginTransaction().add(R.id.map,map1, "map_fragment").commit();
    }
}
