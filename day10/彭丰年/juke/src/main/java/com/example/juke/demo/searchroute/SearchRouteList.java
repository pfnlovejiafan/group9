package com.example.juke.demo.searchroute;
...
import com.example.juke.demo.util.DemoInfo;
import com.example.juke.demo.util.DemoListAdapter;
...
public class SearchRouteList extends AppCompatActivity {
    ...
    private static final DemoInfo[] DEMOS = {
            new DemoInfo(R.string.demo_title_driving_route,R.string.demo_desc_driving_route, WalkingRouteSearchDemo.class),
