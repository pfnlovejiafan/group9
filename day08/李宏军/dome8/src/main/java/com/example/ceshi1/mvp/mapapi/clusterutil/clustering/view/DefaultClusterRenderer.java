...
package com.example.ceshi1.mvp.mapapi.clusterutil.clustering.view;
...
import com.example.ceshi1.mvp.mapapi.clusterutil.MarkerManager;
import com.example.ceshi1.mvp.mapapi.clusterutil.clustering.Cluster;
...
import com.example.ceshi1.mvp.mapapi.clusterutil.projection.Point;
import com.example.ceshi1.mvp.mapapi.clusterutil.projection.SphericalMercatorProjection;
import com.example.ceshi1.mvp.mapapi.clusterutil.ui.IconGenerator;
...
import static com.example.ceshi1.mvp.mapapi.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        com.example.ceshi1.mvp.mapapi.clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private com.example.ceshi1.mvp.mapapi.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        com.example.ceshi1.mvp.mapapi.clusterutil.ui.SquareTextView squareTextView =
                new com.example.ceshi1.mvp.mapapi.clusterutil.ui.SquareTextView(context);
