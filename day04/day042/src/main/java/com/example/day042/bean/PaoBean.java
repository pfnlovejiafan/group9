...
public class PaoBean {
    ...
    public static PaoBean objectFromData(String str) {

        return new Gson().fromJson(str, PaoBean.class);
    }

    public static PaoBean objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), PaoBean.class);
    ...
    public static List<PaoBean> arrayPaoBeanFromData(String str) {

        Type listType = new TypeToken<ArrayList<PaoBean>>() {
        }.getType();

        return new Gson().fromJson(str, listType);
    }

    public static List<PaoBean> arrayPaoBeanFromData(String str, String key) {
